...
<header class="main-header">
	...
	<!-- Logo -->
	<a href="{{ url(config('cms.adminRoute')) }}" class="logo">
	...
	@if(LAConfigs::getByKey('layout') == 'layout-top-nav')
		<div class="container">
			<div class="navbar-header">
				<a href="{{ url(config('cms.adminRoute')) }}" class="navbar-brand"><b>{{ LAConfigs::getByKey('sitename_part1') }}</b>{{ LAConfigs::getByKey('sitename_part2') }}</a>
